...
# code from:  https://raw.githubusercontent.com/akuity/kargo/main/hack/quickstart/kind.sh

set -x

argo_cd_chart_version=7.5.2
...
helm install argocd argo-cd \
  ...
  --set 'server.extensions.contents[0].url=https://github.com/argoproj-labs/rollout-extension/releases/download/v0.3.5/extension.tar' \
  --wait
